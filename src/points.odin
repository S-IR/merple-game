...
when VISUAL_REPRESENTATION_OF_NOISE_FN_RUN {
	...
	Random_Colors_Per_Point_Type := [PointType][5][4]f32 {
		...
		.YellowDirt        = {
			...
			//
			{0.0 / 255.0, 112.0 / 255.0, 75.0 / 255.0, 1},
			{154.0 / 255.0, 0.0 / 255.0, 70.0 / 255.0, 1},
			{157.0 / 255.0, 110.0 / 255.0, 0.0 / 255.0, 1},
			{100.0 / 255.0, 106.0 / 255.0, 69.0 / 255.0, 1},
			{155.0 / 255.0, 100.0 / 255.0, 71.0 / 255.0, 1},
		},
		.PurpleGround      = {
